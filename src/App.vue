        ...
        <el-container class="_container">
            ...
            <el-container class="_main-container">
                <el-aside :class="['_slide', {'_close-slide': isCollapse}]">
                    ...
                    <slide-lang :isCollapse="isCollapse" @setting="settingClick"
                        @lang="setLang"></slide-lang>
                </el-aside>
                <el-container class="_ov-hd" id="body-contion"
                    :class="[{'shack-bg': routePath === '/shack', 'prediction-bg': routePath === '/prediction'}]">
                    <el-main :class="{'maxHeight': prediction }" id="el-main">
                        <div
                            :class="[{'_max-wd': ifoWd, '_farm-wd': farmWd, '_max-100': prediction}]"
...
export default {
    components: {SlideLang, MobileNavs, Top, FooterPage, NavLink, MaskLayer, Tab, Total},
    name: 'App',
    provide() {
        return {
            reload: this.reload,
    ...
    watch: {
        $route: {
            handler: function (val, oldVal) {
                ...
                this.farmWd = ['/ifo', '/farms', '/shack', '/xburger-pool'].includes(val.path);
